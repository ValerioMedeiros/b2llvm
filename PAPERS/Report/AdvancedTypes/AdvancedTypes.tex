...
& \quad \IF \mbox{\B{n} is an array} \THEN \LET v = \variable \IN \trad{n}{ArrayItem}  \sep v \sep t \\
...
The rule ArrayItem is applied in expressions as ``$a(n1,...,n_{n})$'', where $a$ is n.base 
and $n1,...,n_{n}$ is a sequence of indices to select an item from array.
...
&  \llvm{"\PH{p_1} \PH{p_2} \PH{v} =  getelementptr \PH{t_1}, \PH{v_1}, i32 0, i32  \PH{v_2}\nl"}  \sep v \sep t\\
\end{align*}
