...
& \quad \IF \mbox{\B{n} is an array} \THEN \LET v = \variable \IN \\
& \quad \quad \llvm{"\PH{v} = getelementptr \PH{\state(\B{n.root})}* \%self\$,\stateindex(\B{n.index,n.type})  \nl"}\\
& \quad \quad \sep v \sep t \\
...
%TODO example getting
\begin{minted}[frame=single,bgcolor=bg,linenos=true]{pascal}


\end{minted}

%TODO example setting
