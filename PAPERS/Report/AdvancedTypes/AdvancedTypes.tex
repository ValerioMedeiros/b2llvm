...
\begin{figure}[H]
  \begin{center}
	...
	\hline
        ...
        \hline
        \multicolumn{3}{c} {\B{Lit} \alt \B{Term} \alt \B{Pred} \alt}\\
	\multicolumn{3}{c} {\B{Vari} \alt \B{ArrayExp} \alt \B{AArray} } \\
        \hline
  ...
  \begin{tabular}[t]{rcl}
	...
	\multicolumn{3}{c}{\B{Struct} \alt \B{ArrayT}}\\
%	\hline
...
%	\B{type} & : & seq \B{Type}\\
	\hline	
        \multicolumn{3}{|c|}{Array type : \B{ArrayT}} \\
        \hline 
	\B{dom} & : & seq \B{SSet}\\
	\B{ran} & : & \B{SSet}\\
        \hline
        \multicolumn{3}{|c|}{Array expression : \B{ArrayExp}} \\
        \hline
	\multicolumn{3}{c}{ \B{Name} \alt seq \B{Pair} \alt}\\
	\multicolumn{3}{c}{ \B{Product} }\\
	\hline
  	\multicolumn{3}{|c|}{Ordered pair : \B{Pair}} \\
        \hline
	\B{lhs} & : & seq \B{STerm}\\ 
	\B{rhs} & : & \B{Term}\\ 
	\hline
	...
	\B{rhs} & : & \B{Term}\\ 	
	\hline
	\multicolumn{3}{|c|}{Access array : \B{AArray}} \\
        \hline
	\B{exp} & : &  \B{ArrayExp} \\
	\B{type} & : &  \B{ArrayT}\\
	\B{indexes} & : & seq \B{STerm}\\
	\hline
	\multicolumn{3}{|c|}{Simple set : \B{SSet}} \\
	\hline
	\multicolumn{3}{c}{\B{BOOL} \alt \B{NAT} \alt \B{NAT$_{1}$}\alt } \\
	\multicolumn{3}{c}{\B{INT} \alt \B{B0\_Interval}} \\
	\hline
	...
	\hline
	\multicolumn{3}{c}{ \B{Bool\_lit} \alt \B{Int\_lit}\alt \B{Name} } \\ 
      \end{tabular}
    \end{tabular}
  }
  }
