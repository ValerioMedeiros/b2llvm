...
%TODO optionally to remove unsed elements in this table
\begin{figure}[H]
  \begin{center}
    {\footnotesize
      \frame{
...
%	 \llvm{@y = global i32 0 } \\      
  ...
  \caption{Simple example of a B function and its corresponding  C function and LLVM function.
    It is not a real translation, but it help to understand the translation %TODO to update the variables
