...
define void @Test_oper_inc_testCase1(%struct.CuTest* %tc) #0 {
  ...
  store i32 0, i32* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 0), align 4
  store i8 0, i8* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 1), align 1
  call void @counter$init$(%counter$state$* @counter)
  call void @"counter$inc"(%counter$state$* @counter)
  %2 = load i8* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 1), align 1
  %3 = trunc i8 %2 to i1
  %4 = zext i1 %3 to i32
  %5 = icmp eq i32 %4, 1
...
; <label>:6                                       ; preds = %0
  %7 = load i32* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 0), align 4
...
; <label>:9                                       ; preds = %6, %0
  ...
  call void @CuAssert_Line(%struct.CuTest* %12, i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 23, i8* getelementptr inbounds ([18 x i8]* @.str1, i32 0, i32 0), i32 %15)
  ret void
}

declare void @counter$init$(%counter$state$*) #1

declare void @"counter$inc"(%counter$state$*) #1
...
define void @Test_oper_inc_testCase2(%struct.CuTest* %tc) #0 {
  ...
  %condition = alloca i8, align 1
  store %struct.CuTest* %tc, %struct.CuTest** %1, align 8
  store i32 3, i32* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 0), align 4
  store i8 1, i8* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 1), align 1
  call void @"counter$inc"(%counter$state$* @counter)
  %2 = load i8* getelementptr inbounds (%counter$state$* @counter, i32 0, i32 1), align 1
  %3 = trunc i8 %2 to i1
  %4 = zext i1 %3 to i32
...
; <label>:9                                       ; preds = %6, %0
  ...
  %14 = trunc i8 %13 to i1
  %15 = zext i1 %14 to i32
  call void @CuAssert_Line(%struct.CuTest* %12, i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 38, i8* getelementptr inbounds ([18 x i8]* @.str1, i32 0, i32 0), i32 %15)
  ret void
}
...
; <label>:9                                       ; preds = %6, %0
  ...
  %14 = trunc i8 %13 to i1
  %15 = zext i1 %14 to i32
  call void @CuAssert_Line(%struct.CuTest* %12, i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 52, i8* getelementptr inbounds ([18 x i8]* @.str1, i32 0, i32 0), i32 %15)
  ret void
}

declare void @"counter$zero"(%counter$state$*) #1
