...
\begin{align*}
\trad{Structure}{\B{Type}} \isdef \LET tps \BE \trad{Structure.elements}{\ListOf{\B{TField}}} \AND\\
 l \BE \local(\B{Structure.elements})  \IN  \llvm{"\PH{l}= type \{\PH{tps}\}\nl"}
\end{align*}
$$\trad{t}{\B{TField}} \isdef \LET res \BE  \trad{t.type}{\B{Type}} \IN \llvm{"\PH{res},"}$$
...
The function ArrayType returns the type for a declared variable array in 
structure state, for example:
...
[[ TODO: Write about the initialization (Structure and Array) unsing the concept of module/instance]]
