...
\begin{tabular}[t]{rcl}   
	...
	\hline
	\multicolumn{3}{c}{ \B{Vari} \alt \B{ArrayItem} }\\
        \hline
	...
	\hline
        ...
        \hline
        \multicolumn{3}{c} {\B{Lit} \alt \B{Term} \alt \B{Pred} \alt \B{Cons}}\\
	\multicolumn{3}{c} {\B{Vari} \alt \B{Array} \alt \B{ArrayItem} } \\
        \hline
...
The following rule get an element value from the struct. The same rule is used in left side of attribution and right side of attribution. The functions \SBPos(n) and \SBType(n)  get respectively the position and type of $n$ element in the structure. 
\begin{align*}
\begin{split}
...
%( ) The direct attribution between arrays  is madded in similar way 

\section{Arrays}
%TODO: update according the new names in AST, just change the names.
