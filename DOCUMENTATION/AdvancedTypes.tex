...
TODO: show a simple example getting or setting an element of array 
multidimensinal using the rule $ArrayItem$. For example, show the translation of 
this code: $ arr(2,3) :=4$.
...
calculates the address of element. 
